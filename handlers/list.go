...
func ListTodos(manager *models.Manager, app *models.Logger) {
	fmt.Println("")
...
// func listTodosv1(manager *models.Manager) {
// 	fmt.Println("\n_____________________________________________________________________________________________________________________________")
// 	fmt.Println("|   ID   |          Title           |        Content       | Priority |  Category   |  DueDate   | Done? |    Created At    |")
// 	fmt.Println("|────────|──────────────────────────|──────────────────────|──────────|─────────────|────────────|───────|──────────────────|")
...
// 		fmt.Printf("|   %-5v|%-25v |%-21v |     %-5v|%-13v| %-11v|   %-3v | %v |\n", v.ID, v.Title, v.Content, v.Priority, v.Category, dueDate, isDone, createdAt)
